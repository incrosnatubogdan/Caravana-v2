<head>
    ...
    <script type="application/ld+json">
        {
            ...
            "itemListElement": [{
                ...
                "position": 2,
                "name": "Doneaza",
                "item": "http://caravanacumedici.ro/doneaza.html"
            }, {
                "@type": "ListItem",
                "position": 3,
                "name": "Media",
                "item": "http://caravanacumedici.ro/media.html"
            }, {
                "@type": "ListItem",
                "position": 4,
                "name": "Contact",
                "item": "http://caravanacumedici.ro/contact.html"
            }]
        }
    </script>
    </script>
    ...
    <script src="assets/js/miranda.min.js"></script>
    ...
    <script>
        $(document).ready(function () {
            var linkAjax = 'assets/ajax/acasa.json';
            $("#main-media").mirandajs(linkAjax);
        });
    </script>
</head>
...
<body>
                ...
                <div class="overflow-row" id="main-media">
                    <div class="element">
                        <a href="[[link]]">
                            ...
                            <p class="blue-c">[[title]] - [[location]]</p>
                            <img class="icon" src="[[icon]]">
                            <span class="blue-c">[[date]]</span>
                            <p class="media-testimonial">[[testimonial]]</p>
                        </a>
                    </div>
                </div>
            </section>
            <section class="team-section">
                ...
                <div class="grid numbers">
                    <div class="element no-shadow">
                        ...
                        <p class="uppercase blue-c counter" data-count="7093">0</p>
                        <p class="uppercase blue-c">Pacienți Consultați</p>
                    </div>
                    <div class="element no-shadow">
                        <img src="assets/img/icon/voluntari.svg">
                        <p class="uppercase blue-c counter" data-count="700">0</p>
                        <p class="uppercase blue-c">Voluntari</p>
                    </div>
                    <div class="element no-shadow">
                        <img src="assets/img/icon/caravane.svg">
                        <p class="uppercase blue-c counter" data-count="66">0</p>
                        <p class="uppercase blue-c">Caravane</p>
                    </div>
                    <div class="element no-shadow">
                        <img src="assets/img/icon/km-parcursi.svg">
                        <p class="uppercase blue-c counter" data-count="32905">0</p>
                ...
                <div class="row">
                    <div class="partner">
                        <a href="https://www.synevo.ro/">
                            <img src="assets/img/partners/synevo.png">
                        </a>
                    </div>
                    <div class="partner">
                        <a href="http://www.servier.ro/">
                            <img src="assets/img/partners/servier.png">
                        </a>
                    </div>
                    <div class="partner">
                        <a href="https://www.avon.ro/">
                            <img src="assets/img/partners/avon.png">
                        </a>
                    </div>
                    >
                    <div class="partner">
                        <a href="https://www.bayer.ro/">
                            <img src="assets/img/partners/bayer.png">
                        </a>
                    </div>
                </div>
            </section>
    ...
    <div id="popup" class="popup-overlay popup-newsletter">
        <div class="popup newsletter_popup">
            <div class="close">
                <span class="horizontal"></span>
                <span class="vertical"></span>
            </div>
            <h3>Avem newsletter</h3>
            <p>Mai mult text aici, afla info, stiri noi, newsletter fffff dulci</p>
            <div id="newsletter">
                <div class="input-holder">
                    <input type="text" name="" id="" placeholder="email">
                    <img src="http://onetwopixel.com/wp-content/uploads/2018/02/animat-paper-airplane-color.gif" alt="">
                </div>
            </div>
        </div>
    </div>
