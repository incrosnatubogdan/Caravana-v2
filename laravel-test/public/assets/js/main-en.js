var JSON = {
    menu: [
        {name: 'Home', link: 'index', sub: null, class: "", target: "_self", id:""},
        {name: 'About us', link: '', sub: null, class: "", target: "_self", id:"dropdown-2"},
        {name: 'What we do', link: '', sub: null, class: "", target: "_self", id:"dropdown"},
        {name: 'Get involved', link: 'get-involved', sub: null, class: "", target: "_self", id:""},
        {name: 'Partners', link: 'partners', sub: null, class: "", target: "_self", id:""},    
        {name: 'Media', link: 'media', sub: null, class: "", target: "_self", id:""},
        {name: 'Contact', link: 'contact', sub: null, class: "", target: "_self", id:""},
        {name: 'Request Caravan', link: 'request-caravan', sub: null, class: "special", target: "_self", id:""},
        {name: 'Support us', link: 'donate', sub: null, class: "special donate-btn", target: "_self", id:""},
...
$(function () {     
    ...
    if ($(".main.container").hasClass("caravan")) {
        ...
        $("#dropdown").append('<div class="dropdown-content"><a href="../mobile_unit">Mobile Unit</a><a href="../health_education">Health education</a><a href="../reports">Annual reports</a></div>')
        $("#dropdown-2").append('<div class="dropdown-content"><a href="../about-us">About Us</a><a href="../team">Team</a></div>')
    } else {
