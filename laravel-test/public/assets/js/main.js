...
$(function () {
    ...
    if ($(".main.container").hasClass("caravan")) {
        ...
        $("#dropdown").append('<div class="dropdown-content"><a href="../unitatea-mobila">Unitatea Mobila</a><a href="../educatie-medicala">Educatie pentru sanatate</a><a href="../rapoarte">Rapoarte anuale</a></div>')
        $("#dropdown-2").append('<div class="dropdown-content"><a href="../despre-noi">Cine Suntem</a><a href="../echipa">Echipa</a></div>')
    } else {
