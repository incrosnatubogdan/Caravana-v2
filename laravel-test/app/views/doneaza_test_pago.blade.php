    ...
    <div class="page-holder">
        ...
        <div class="main container donation-holder">
            ...
            <div style="width: 90%;margin: 30px auto;display: block;" class="shadow-block">
                ...
                <h3 style="margin-top: 20px">Donează online prin Pago</h3>
                <div class="shadow-block donation_block pago">
                    <div class="pago--left">
                        <img src="assets/img/paypal/pago/pago_left.png" alt="">
                        <div class="text-block">
                            <h4>Susține Caravana cu medici</h4>
                            <p>Caravana cu Medici este una dintre cele 15 organizații din echipa Donează cu Pago.
                                Împreună ne dorim să transformăm procesul de donație într-unul simplu, sigur și
                                transparent.</p>
                            <button class="paypal mobilpay">
                                <a href="https://mpy.ro/12gdzhev">
                                    DONEAZĂ RAPID ȘI SIGUR
                                </a>
                            </button>
                        </div>
                    </div>
                    <div class="pago--right">
                        <img src="assets/img/paypal/pago/pago_right.png" alt="">
                    </div>
                </div>
