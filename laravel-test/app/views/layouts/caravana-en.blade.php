...
<head>
    ...
    <title>Caravan {{$caravanNo}} - @yield('title')</title>
    ...
    <script src="{{URL::asset('/assets/js/main-en.min.js')}}"></script>
...
<body>
    <div class="page-holder">
        <nav class="menu">
            <a href="../../caravane/{{$caravanNo}}" class="lang">RO</a>
        ...
        <div class="main container caravan">
            <h3 class="team-title blue-c uppercase show-title">Caravan no. {{$caravanNo}} - @yield('title')</h3>
            ...
            <footer>
                <img>
                <p class="quote">
                    "Only a life lived for others is a life worth living." <br>
                    - Albert Einstein
                </p>
